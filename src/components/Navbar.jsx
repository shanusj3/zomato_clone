    ...
    return (
        <nav className='px-3 md:px-36 bg-white'>
            <div className='flex justify-between items-center py-8 container mx-auto flex-col lg:flex-row gap-5 lg:gap-0'>
                <span><h1 className='text-5xl font-extrabold italic text-blackCol'>zomato</h1></span>
                ...
                <div className='flex gap-4'>
                    <NavLink to="/" className="text-xl text-blackSe hover:text-blackPr">Home</NavLink>
                    <NavLink to="/cart" className="text-xl text-blackSe hover:text-blackPr">Cart</NavLink>
                </div>
            </div>
